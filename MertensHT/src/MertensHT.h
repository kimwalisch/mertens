...
//
// Single entry point: MertensHT(x). Tested through 10^23; larger inputs are
// enabled by guarded 256-bit fallbacks (see the paper, Section 10).
//
...
//
// Tunable parameters: vdiv, C, D, ntasksMul, sarrCapBytes (see signature).
// ============================================================================
